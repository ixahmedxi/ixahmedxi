...
import { HamburgerIcon } from '../components/Home/HamburgerIcon'
          ...
          <div>
            <div sx={{ height: '27px', overflow: 'hidden' }}>
              <motion.div
                ...
                <p>Hey!</p>{' '}
                <div
                  sx={{ width: '300px', height: '2px', bg: 'text', ml: 3 }}
                />
              </motion.div>
            </div>
            ...
            <div sx={{ height: '54px', overflow: 'hidden' }}>
              <motion.h3
                ...
                I am a <strong>full stack web developer</strong>. I like
            ...
            <div sx={{ height: '27px', overflow: 'hidden', mt: 2 }}>
              <motion.h5
                initial={{ y: 96 }}
                animate={{ y: 0 }}
            ...
            <motion.a
              ...
              <div sx={{ display: 'flex', alignItems: 'center' }}>
                view my work <FaLongArrowAltRight sx={{ ml: 2, fontSize: 2 }} />
              </div>
            </motion.a>
          </div>
        </div>
