    ...
    <LeftColumnWrapper>
      <div>
        ...
        <LeftColumnDescription>
          These are some of the projects that I have created in the past, some
          of these projects I am still actively working on improving them
          further. There are a lot more projects that can be found on my
          different accounts.
        </LeftColumnDescription>
        <AboutButton href='#about'>
          <span>
            About Me <FaLongArrowAltRight style={{ marginLeft: '15px' }} />
          </span>
        </AboutButton>
        <div>
